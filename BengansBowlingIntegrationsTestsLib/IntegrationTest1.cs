...
namespace BengansBowlingIntegrationsTestsLib
{
    public class IntegrationTest1
    {
        ...
        {
            var serie1Id = sut.CreateSerie(sut.GetParty(1), 50);
            var serie2Id = sut.CreateSerie(sut.GetParty(2), 70);
            ...
            var serie3Id = sut.CreateSerie(sut.GetParty(1), 50);
            var serie4Id = sut.CreateSerie(sut.GetParty(2), 110);
            ...
            var serie5Id = sut.CreateSerie(sut.GetParty(1), 230);
            var serie6Id = sut.CreateSerie(sut.GetParty(2), 110);
            ...
            var comp = sut.GetCompetition(compId);
            var matchRounds = sut.GetMatch(matchId);
